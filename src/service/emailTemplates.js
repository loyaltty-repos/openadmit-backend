...
export const OtpEmailTemplate = (otp) => {
  const subject = 'Your Secure OTP Code - Open Admit';
  const text = `Your OTP is: ${otp}. It is valid for the next 10 minutes. If you did not request this, please ignore this email.`;
  ...
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="x-apple-disable-message-reformatting" />
    <title>Verify Your OTP - Open Admit</title>
            ...
            <tr>
              <td>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="card">
                        ...
                        <tr>
                          <td>
                            <div class="notice">
                              <p style="margin:0;">
                                <strong>Security Alert:</strong> Never share this OTP with anyone.
                                The Open Admit team will <strong>never</strong> ask for your OTP via call, SMS, or email.
                              </p>
                            </div>
                          </td>
                        </tr>
                        ...
                        <tr>
                          <td>
                            <div class="support-card">
                              <h3>Need Help?</h3>
                              <p>Our support team is here 24/7</p>
                              <p><a href="mailto:support@openadmit.com">support@openadmit.com</a></p>
                              <p><a href="tel:+14156722765">+1 415 672 2765</a></p>
                            </div>
                          </td>
                        </tr>
                  ...
                  <tr>
                    <td class="footer" style="background-color:#f4f7fb;">
                      <p style="margin:6px 0;">© 2025 <strong>Open Admit</strong>. All rights reserved.</p>
                      <p style="margin:6px 0;">This is an automated security email. Please do not reply.</p>
                      <p style="margin:6px 0;">
                        <a href="#">Unsubscribe</a> |
                        <a href="#">Privacy Policy</a> |
...
export const WelcomeEmailTemplate = (studentName ) => {
  const subject = `Welcome to Open Admit, ${studentName || 'Student'}!`;
  const text = `Hi ${studentName || 'Student'},\n\nWelcome to Open Admit! We're thrilled to have you on board.\n\nYour account is now active. Explore your dashboard, complete your first task, and start your learning journey.\n\nNeed help? We're here 24/7.\n\nBest regards,\nOpen Admit Team`;
  ...
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="x-apple-disable-message-reformatting" />
    <title>Welcome to Open Admit!</title>
  ...
  <body>
    <!-- Preheader (hidden preview text) -->
    <div style="display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0;">
      Welcome to Open Admit—your account is active. Jump into your dashboard and start your journey!
    </div>
            ...
            <tr>
              <td>
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" class="card">
                  ...
                  <tr>
                    <td class="header">
                      <h1 class="brand" style="margin:0 0 12px;">Open Admit</h1>
                      <p class="greeting" style="margin:0;">Hi ${studentName || 'Student'}, Welcome Aboard!</p>
                    </td>
                  </tr>
                      ...
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                        <tr><td>
                          <div class="welcome-box">
                            ...
                            <h2 class="welcome-title">You're All Set!</h2>
                            <p class="welcome-message">
                              Your Open Admit account is now active. Get ready to learn, grow, and achieve your goals with personalized tasks and real-time feedback.
                            </p>
                          </div>
                        </td></tr>
                      </table>
                      ...
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                        <tr><td>
                          <div class="cta-card">
                            ...
                            <!--[if mso]>
                              <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"
                                href="https://openadmit.com/dashboard" style="height:44px;v-text-anchor:middle;width:240px;" arcsize="12%" strokecolor="#145044" fillcolor="#145044">
                                <w:anchorlock/>
                                <center style="color:#ffffff;font-family:Arial,sans-serif;font-size:16px;font-weight:700;">Go to Dashboard</center>
                              </v:roundrect>
                            <![endif]-->
                            <!--[if !mso]><!-- -->
                              <a href="https://openadmit.com/dashboard"
                                 style="display:inline-block;background:#145044;color:#ffffff;padding:14px 32px;border-radius:8px;font-weight:600;font-size:16px;box-shadow:0 4px 12px rgba(20,80,68,0.2);">
                                 Go to Dashboard
                              </a>
                            <!--<![endif]-->
                  ...
                  <tr>
                    <td class="footer">
                      <p style="margin:6px 0;">© 2025 <strong>Open Admit</strong>. All rights reserved.</p>
                      <p style="margin:6px 0;">You're receiving this email because you signed up at Open Admit.</p>
                      <p style="margin:6px 0;">
                        <a href="#">Unsubscribe</a> |
                        <a href="#">Privacy Policy</a> |
                        <a href="#">Contact Us</a>
...
export const AdminQuestionnaireSubmissionTemplate = (studentEmail, studentName, taskTitle, subtaskTitle, questionnaireTitle) => {
    ...
    <head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>New Submission Alert - Open Admit Admin</title>
        <style>
            body, table, td, a { -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; }
            table, td { mso-table-lspace: 0pt; mso-table-rspace: 0pt; }
            img { -ms-interpolation-mode: bicubic; border: 0; height: auto; line-height: 100%; outline: none; text-decoration: none; }
        ...
        <div class="email-container">
            ...
            <div class="content">
                ...
                <div class="action-card">
                    <h3>Review Now</h3>
                    <p>Check the admin dashboard to view responses and provide feedback.</p>
                    <a href="https://admin.openadmit.com/submissions" class="btn">Go to Dashboard</a>
                </div>
            </div>

            <!-- Footer -->
            <div class="footer">
                <p>© 2025 <strong>Open Admit</strong>. All rights reserved.</p>
                <p>This is an automated admin alert.</p>
                <p>
                    <a href="#">Unsubscribe</a> | 
                    <a href="#">Contact Support</a>
...
export const QuestionnaireSubmissionTemplate = (taskTitle, subtaskTitle, questionnaireTitle) => {
    const subject = `Submission Received: ${questionnaireTitle} - Open Admit`;
    const text = `Hi there,\n\nYour responses for "${questionnaireTitle}" under "${subtaskTitle}" in "${taskTitle}" have been successfully submitted.\n\nThank you for your participation!\n\nBest regards,\nOpen Admit Team`;
    ...
    <head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>Submission Confirmed - Open Admit</title>
        <style>
            body, table, td, a { -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; }
            table, td { mso-table-lspace: 0pt; mso-table-rspace: 0pt; }
            img { -ms-interpolation-mode: bicubic; border: 0; height: auto; line-height: 100%; outline: none; text-decoration: none; }
...
export const TaskAssignedTemplate = (studentName, taskTitle) => {
    const subject = `New Task Assigned: ${taskTitle} - Open Admit`;
    const text = `Hi ${studentName},\n\nA new task has been assigned to you!\n\nTask: ${taskTitle}\n\nHead over to your dashboard to view details and get started.\n\nBest regards,\nOpen Admit Team`;
    ...
    <head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>New Task Assigned - Open Admit</title>
        <style>
            body, table, td, a { -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; }
            table, td { mso-table-lspace: 0pt; mso-table-rspace: 0pt; }
            img { -ms-interpolation-mode: bicubic; border: 0; height: auto; line-height: 100%; outline: none; text-decoration: none; }
        ...
        <div class="email-container">
            ...
            <div class="content">
                ...
                <div class="cta-card">
                    <h3>Ready to Start?</h3>
                    <p>View task details, submit responses, and track your progress</p>
                    <a href="https://openadmit.com/dashboard" class="cta-btn">Go to Dashboard</a>
                </div>
...
export const PaymentConfirmationEmailTemplate = (data) => {
  ...
  const subject = 'Payment Confirmation - Open Admit';
  const text = `Hi ${studentName},
...
Your plan is now active. Welcome to Open Admit!
`;
  ...
  <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Payment Confirmation - Open Admit</title>
      <style>
          body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; }
          .header { background-color: #145044; color: white; padding: 30px 20px; text-align: center; border-radius: 10px 10px 0 0; }
          .content { background-color: #f9f9f9; padding: 30px 20px; border-radius: 0 0 10px 10px; }
  ...
  <body>
      <div class="header">
          <div class="success-icon">✓</div>
          <h1>Payment Successful!</h1>
          <p>Thank you for choosing Open Admit. Your journey to success starts now!</p>
      </div>
      ...
      <div class="content">
          ...
          <div style="text-align: center; margin: 30px 0; padding: 20px; background-color: #f0f8f6; border-radius: 8px;">
              <h3 style="color: #145044; margin-top: 0;">Need Help?</h3>
              <p style="margin: 10px 0;">Our support team is here to assist you</p>
              <p style="margin: 5px 0;">📧 support@openadmit.com</p>
              <p style="margin: 5px 0;">📞 +1 415 672 2765</p>
          </div>
      </div>
      
      <div class="footer">
          <p>© 2024 Open Admit. All rights reserved.</p>
          <p>This is an automated email. Please do not reply to this email.</p>
      </div>
  </body>
  </html>
...
export const PaymentInitiationAdminEmailTemplate = (data) => {
  ...
  const subject = 'New Payment Initiated - Open Admit';
  const text = `New payment initiated on Open Admit:
...
This is an initiation notification. Final status depends on verification and capture.`;
  ...
  <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>New Payment Initiated - Open Admit</title>
      <style>
          body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; }
          .header { background-color: #145044; color: white; padding: 24px 20px; text-align: center; border-radius: 10px 10px 0 0; }
          .content { background-color: #f9f9f9; padding: 24px 20px; border-radius: 0 0 10px 10px; }
  ...
  <body>
      <div class="header">
          <h2>New Payment Initiated</h2>
          <p>A student has initiated a payment on Open Admit.</p>
      </div>
      <div class="content">
          <div class="order-details">
              <h3 style="margin-top:0;color:#145044;">Payment Details</h3>
      ...
      <div class="footer">
          <p>© 2024 Open Admit. Internal notification email.</p>
      </div>
  </body>
  </html>
  `;
